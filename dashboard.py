...
CHANGES:
  ...
  - Removed: Satisfaction stat card, User Satisfaction chart, Recent Feedback section
  - Removed: get_feedback_list import and all feedback-related calculations
"""

import streamlit as st
from database import (
    get_stats, get_queries_per_day, get_top_queries,
    get_avg_response_time, get_active_users_today
)
...
""", unsafe_allow_html=True)
    ...
    # ── Stat cards — 6 cards (satisfaction removed) ──
    st.markdown(f"""
